...
def pay_down_implications():
    if user_plans != True:
        ...
        new_daily_interest = 2*(user_principle - payment_more_than_minimum)/365/100*user_apr
        new_pay_check_percentage = (new_daily_interest * user_pay_period) / user_pay_check_amount
        message = print('If you make a payment of ${} before the next due date, this loan will begin eating up %{} of your pay-checks.'.format(payment_more_than_minimum, new_pay_check_percentage))
        return message
